...
from ai_business_assistant.api.routes import market_router, forecasting_router, \
    ...
    auth_router, data_router, export_router, webhooks_router, tasks_router, models_router
...
app.include_router(models_router, prefix="/api/v1/models", tags=["Model Management"])
